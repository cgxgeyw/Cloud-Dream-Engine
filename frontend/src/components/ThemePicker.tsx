...
/**
 * ThemePicker — shared component for selecting theme style and light/dark mode.
 * Used in settings pages (desktop + mobile).
 */
  ...
  return (
    <div className="theme-picker">
      <div className="theme-picker-section">
        <h4 className="theme-picker-heading">外观风格</h4>
      ...
      <div className="theme-picker-section">
        <h4 className="theme-picker-heading">明暗模式</h4>
